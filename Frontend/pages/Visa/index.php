...
<body>
  ...
  <div class="center">
    <div class="center__content">
      <h1>Открывай мир с Chocotravel</h1>
      <h3>Онлайн оформление визы в более 40 стран мира</h3>
    </div>
    <div class="visa__images">
      <div class="visa__img" style="
          background-image:
          url('https://s3.eu-central-1.amazonaws.com/chocotravel/media/images/popular_items/cities/tkmgvmhrxsvh955drcme.jpg');
          ">
        <p>США</p>
      </div>
      <div class="visa__img" style="
          background-image:
          url('https://s3.eu-central-1.amazonaws.com/chocotravel/media/images/popular_items/cities/c9bzvi8jhfmijhny5zyx.jpg');
          ">
        <p>Австралия</p>
      </div>
      <div class="visa__img" style="
          background-image:
          url('https://s3.eu-central-1.amazonaws.com/chocotravel/media/images/popular_items/cities/2u1jmubc0nvbg5uujxet.jpg');
          ">
        <p>Япония</p>
      </div>
      <div class="visa__img" style="
          background-image:
          url('https://s3.eu-central-1.amazonaws.com/chocotravel/media/images/popular_items/cities/bzcrfwaijgy6gai5v8un.jpg');
          ">
        <p>Чехия</p>
      </div>
    </div>
    <div id="visa-form-app" class="mt-4">
      <div class="visa__form">
        ...
        <button class="visa__button">Отправить заявку</button>
      </div>
    </div>
  </div>
  <!-- content -->
