...
<body>
  ...
  <main class="container">
    <section class="container-wrapper">
      <h2>Лучшие цены на авиабилеты</h2>
      <p>
        Помощник путешественнику. Найди лучшую цену в любую часть мира! Цены,
        обнаруженные за последние 3 дня.
      </p>
      <div class="container-wrapper__div">
        <div class="container-wrapper__div2">
          <span style="display: grid; font-size: 12px">
            Город, страна или регион вылета

            <input type="text" placeholder="Ex: Almaty" />
          </span>

          <span style="display: grid; font-size: 12px">
            Город, страна или регион прилета

            <input type="text" placeholder="Ex: Europe" />
          </span>
        ...
        <div class="container-wrapper__div2">
          ...
          <span style="display: grid; font-size: 12px">
            в обе стороны
            <select>
              <option>В обе стороны</option>
              <option>В одну стороны</option>
            </select>
          </span>
        </div>
