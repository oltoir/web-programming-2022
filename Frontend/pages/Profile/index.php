...
<body>
  ...
  <main class="container">
    <div class="container-wrapper">
      <h1 style="text-align: center">Мои рейсы</h1>
      <?php
      ...
      $sql = "SELECT DISTINCT flights.departure_city, flights.arrival_city, flights.departure_date, flights.arrival_date, flights.departure_time, flights.arrival_time, flights.carrier FROM users INNER JOIN bookings INNER JOIN flights ON bookings.user_id = " . $_SESSION["user_id"] . " AND bookings.flight_id = flights.id";
      $result = mysqli_query($conn, $sql);
      echo "<table border='1'>";
      echo "<div style=\"display:flex; flex-direction:column\">";
      echo "<div style=\"display:flex; flex-direction:row\">";
      echo "<th style=\"padding:5px;\">Город вылета</th>";
      echo "<th style=\"padding:5px;\">Город назначения</th>";
      echo "<th style=\"padding:5px;\">Дата вылета</th>";
      echo "<th style=\"padding:5px;\">Дата прилета</th>";
      echo "<th style=\"padding:5px;\">Время вылета</th>";
      echo "<th style=\"padding:5px;\">Время прилета</th>";
      echo "<th style=\"padding:5px;\">Авиакомпания</th>";
